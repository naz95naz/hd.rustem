...
'ALLSTATS_help' => 'У цьому розділі міститься статистика всіх відділів та їх користувачів, на які Ви маєте права доступу.',
...
'FILES_off' => 'Наразі вимкнено завантаження файлів до заявки. Для увімкнення перейдіть <a href="./config"> сюди </a> й активуйте завантаження файлів до заявки. ', 
'FILES_info' => 'У цьому разділі ви можете переглянути всі прикріплені файли до заявки, а також видалити їх.', 
'FILES_name' => 'Файл', 
'FILES_ticket' => 'Заявка', 
'FILES_size' => 'Розмір',
'T_from'=>'з',
...
'FILES_down'=>'Завантажити',
     'HELPER_info'=>'У цьому розділі можуть міститися інструкції та документація для вирішення типових проблем.',
    'CONF_info'=>'У цьому розділі містяться основні налаштування системи.',
    'TICKET_t_a_e_prio'=> 'в заявці був змінений пріоритет',
    'DEPS_off'=>'Наразі вимкнено фіксований список тем заявок. Для його ввімкнення перейдіть <a href="./config"> сюди </a> і виберіть теми заявок "фіксований список".',
'CONF_file_types'=>'Дозволені типи файлів',
'CONF_file_size'=>'Максимальний розмір файлу',
...
'CONF_f_login' => 'Перший вхід й активація',
'CONF_f_login_opt_true' => 'Доступне посилання',
'CONF_false' => 'Не активно ',
'CONF_f_login_info' => 'Якщо у Вас вже є база користувачів (а точніше їх email), то кожен новий користувачів буде вводити email, і якщо такий вже є в базі, то на нього буде надсилатися пароль. Адміністратора це позбавляє від створення паролів й активування облікових записів. ',
'CONF_subj' => 'Теми заявок',
'CONF_fix_list' => 'Фіксований список',
'CONF_subj_text' => 'Поле введення',
'CONF_subj_info' => 'У разі створення заявок Ви можете визначити фіксований набір тем або ж текстове поле, у яке вписують назву теми заявки.',
...
'LIST_pin' => 'Відділів',
        ...
        'APPROVED_info' => 'У цьому розділі містяться запити користувачів системи на зміну інформації про клієнтів (користувачів).',
         'WORKERS_info' => 'У цьому розділі міститься інформація про користувачів (клієнтів), ви можете знайти користувача та відправити запит на зміну інформації. Якщо у вас є достатньо прав, то зміна відбудеться одразу без підтвердження.',
	...
	'NEW_ok_4' => 'роздрукуйте її',
        ...
        'NEW_fio' => 'ПІБ, логін або телефон користувача',
        ...
        'LIST_find_ph' => 'Введіть # заявки, тему заявки, текст заявки або текст коментаря',
        'LIST_find_button' => 'Пошук',
        'LIST_in' => 'Вхідні',
        'LIST_out' => 'Вихідні',
        'LIST_arch' => 'Архів',
        'LIST_loading' => 'Триває завантаження',
        ...
        'CREATE_ACC_error' => 'Не знайдено користувача з такою електронною адресою.',
...
't_list_a_nook' => 'позначити, як не виконане',
...
't_list_a_p_norm' => 'Середній прiоритет',
't_list_a_p_low' => 'Низький прiоритет',
't_list_a_p_high' => 'Високий прiоритет',
...
'TABLE_name' => 'Назва',
'TABLE_action' => 'Дія',
'PROFILE_msg_send' => 'Запит на зміну інформації про користувача надіслано. Зміни відбудуться тільки після перевірки адміністратором.',

'TICKET_msg_OK' => 'Заявка виконана',
'TICKET_msg_OK_error' => 'Неможливе виконання. Заявка вже виконана користувачем',
'TICKET_msg_unOK' => 'Заявка не виконана',
'TICKET_msg_unOK_error' => 'Неможливе не виконання',
